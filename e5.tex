...
For all 1748 descriptions, the production (categorical gesture vs.\@ no gesture) of each type of gesturing (Iconic, Beat, Point, Adaptors, and Others) was modelled using mixed effects logistic regression. 
