...
To test whether our results pattern with previous research in showing an increase of gesturing with an increase in cognitive load, both the occurrence (gesture vs.\@ no gesture) and the duration (Z-scored) of iconic gesturing was modelled with the same fixed and random effect structure.
...
To investigate whether gesturing co-varies or trades off against speech, the duration of iconic gesturing (Z-scored) was modelled analogously, but with the inclusion of utterance duration as a predictor .
