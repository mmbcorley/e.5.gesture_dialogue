...
%JK mention anything about gesture rate measures?
...
%link. different types of gesture = different purposes. tradeoff might hold somewhere?
...
%JK these studies didn't look at speech so much. 
...
Additionally, all gestures were coded for the hands used (Left, Right, or Both), and whether the representational part of the gesture was conveyed dynamically, statically, or used a combination. 
